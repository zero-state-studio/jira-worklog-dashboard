    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-surface">
            <div className="bg-surface p-8 rounded-lg shadow-xl max-w-md w-full">
                ...
                {/* Email display */}
                {email && (
                    <div className="bg-surface/50 rounded-lg px-4 py-3 mb-6">
                        <p className="text-xs text-tertiary mb-1">Account</p>
                ...
                {/* Error */}
                {error && (
                    <div className="bg-red-500/10 border border-red-500/30 text-error px-4 py-3 rounded-lg mb-6 text-sm">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-6">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 bg-surface border border-solid rounded-lg text-white placeholder-dark-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            disabled={loading}
                            autoFocus
                        />
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-accent text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
                    >
                        {loading ? (
                            <>
